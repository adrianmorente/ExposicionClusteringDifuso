	...
	\chapter{Agrupamiento clásico}
		...
		\section{Modelos de agrupamiento clásico}
			...
			\begin{figure}
				...
				\caption{Agrupamiento clásico - Modelo por conectividad}
			\end{figure}
			...
			\begin{figure}
				...
				\caption{Agrupamiento clásico - Modelo basado en centroide}
			\end{figure}
			...
			\begin{figure}
				...
				\caption{Agrupamiento clásico - Modelo basado en distribuciones}
			\end{figure}
			...
			\begin{figure}
				...
				\caption{Agrupamiento clásico - Modelo basado en densidad}
			\end{figure}
